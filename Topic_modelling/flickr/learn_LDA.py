...
lda_model_80.save('/home/yash/Data/flickr/LDA_MODELS/lda_model_train_80.lda')

lda_model_30 = gensim.models.ldamulticore.LdaMulticore(corpus = mm, id2word=id2word ,num_topics = 30, workers=3)
lda_model_30.save('/home/yash/Data/flickr/LDA_MODELS/lda_model_train_30.lda')

lda_model_10 = gensim.models.ldamulticore.LdaMulticore(corpus = mm, id2word=id2word ,num_topics = 10, workers=3)
lda_model_10.save('/home/yash/Data/flickr/LDA_MODELS/lda_model_train_10.lda')
