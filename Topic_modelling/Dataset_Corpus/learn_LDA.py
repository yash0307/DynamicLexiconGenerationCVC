...
mm = gensim.corpora.MmCorpus('/media/DADES/yash/topicModelDataset/Dataset_Corpus/corpus_train.mm')
...
lda_model_2000.save('/media/DADES/yash/topicModelDataset/Dataset_Corpus/lda_model_train_2000.lda')
