...
def main():
    ...
    f = open('results_train_200.txt','w')
    ...
    lda_model = gensim.models.ldamodel.LdaModel.load('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Natural_dict/lda_model_train_200.lda', mmap='r')
