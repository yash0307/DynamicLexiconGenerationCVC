...
def create_inception_graph():
    ...
    with tf.Session() as sess:
        model_filename = '/media/DADES/yash/git_CVC_2/tf_inception_finetuning/Jad_sw_dict/output_graph_all.pb'
...
def main():
    ...
    lda_model = gensim.models.ldamodel.LdaModel.load('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Jad_sw_dict/lda_model_30.lda', mmap='r')
