...
def main():
    ...
    f = open('results_train_500.txt','w')
    ...
    lda_model = gensim.models.ldamodel.LdaModel.load('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Natural_dict/lda_model_train_500.lda', mmap='r')
