...
def create_inception_graph():
    ...
    with tf.Session() as sess:
        model_filename = '/media/DADES/yash/git_CVC_2/tf_inception_finetuning/Jad_dict/output_graph.pb'
...
def main():
    ...
    # Image base_url.
    base_url_image = '/media/DADES/yash/MS-COCO/inceptionImages/validation/'
    url_script = '/media/DADES/yash/git_CVC_2/tf_inception_finetuning/Jad_dict/deploy.py'
    ...
    lda_model = gensim.models.ldamodel.LdaModel.load('/media/DADES/yash/Wikipedia/jad_lda_model.lda', mmap='r')
    ...
    for ind in im_ids_txt:
        ...
        if not words_present:
            ...
            query_out = make_query(final_url, url_script)
    ...
    f.close()
def make_query(image_url, script_url):
    global id2word
    global lda_model
    ...
    top_10_vals = sorted(query_out, key=lambda x:x[1], reverse=True)[0:20]
    return top_10_vals
