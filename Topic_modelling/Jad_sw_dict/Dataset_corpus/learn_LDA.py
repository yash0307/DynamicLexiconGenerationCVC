...
mm = gensim.corpora.MmCorpus('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Jad_sw_dict/corpus.mm')

lda_model_400 = gensim.models.ldamulticore.LdaMulticore(corpus = mm, id2word=id2word ,num_topics = 400, workers=3)
lda_model_400.save('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Jad_sw_dict/lda_model_400.lda')

lda_model_200 = gensim.models.ldamulticore.LdaMulticore(corpus = mm, id2word=id2word ,num_topics = 200, workers=3)
lda_model_200.save('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Jad_sw_dict/lda_model_200.lda')

lda_model_100 = gensim.models.ldamulticore.LdaMulticore(corpus = mm, id2word=id2word ,num_topics = 100, workers=3)
lda_model_100.save('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Jad_sw_dict/lda_model_100.lda')

lda_model_50 = gensim.models.ldamulticore.LdaMulticore(corpus = mm, id2word=id2word ,num_topics = 50, workers=3)
lda_model_50.save('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Jad_sw_dict/lda_model_50.lda')

lda_model_500 = gensim.models.ldamulticore.LdaMulticore(corpus = mm, id2word=id2word ,num_topics = 500, workers=3)
lda_model_500.save('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Jad_sw_dict/lda_model_500.lda')

lda_model_1000 = gensim.models.ldamulticore.LdaMulticore(corpus = mm, id2word=id2word ,num_topics = 1000, workers=3)
lda_model_1000.save('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Jad_sw_dict/lda_model_1000.lda')
...
lda_model_80.save('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Jad_sw_dict/lda_model_80.lda')

lda_model_30 = gensim.models.ldamulticore.LdaMulticore(corpus = mm, id2word=id2word ,num_topics = 30, workers=3)
lda_model_30.save('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Jad_sw_dict/lda_model_30.lda')

lda_model_10 = gensim.models.ldamulticore.LdaMulticore(corpus = mm, id2word=id2word ,num_topics = 10, workers=3)
lda_model_10.save('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Jad_sw_dict/lda_model_10.lda')
