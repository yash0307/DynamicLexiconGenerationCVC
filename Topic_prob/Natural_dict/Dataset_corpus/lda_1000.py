...
def main():
    ...
    f = open('results_train_1000.txt','w')
    ...
    lda_model = gensim.models.ldamodel.LdaModel.load('/media/DADES/yash/topicModelDataset/Dataset_Corpus/Natural_dict/lda_model_train_1000.lda', mmap='r')
