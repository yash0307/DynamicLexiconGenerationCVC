...
lda_model_400 = gensim.models.ldamodel.LdaModel(corpus = mm, id2word=id2word ,num_topics = 1000, alpha='auto')
lda_model_400.save('/home/yash/DynamicLexiconGenerationCVC/flickr_LDA_MODELS/train_corpus/lda_model_train_auto_1000.lda')
