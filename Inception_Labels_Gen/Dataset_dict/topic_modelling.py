...
def main():
    ...
    mm = gensim.corpora.MmCorpus('/media/DADES/yash/topicModelDataset/Dataset_Corpus/corpus.mm')
    ##########################################################################################
    ############################## Training Models ###########################################
    ##########################################################################################
    lda_model = gensim.models.ldamodel.LdaModel.load('/media/DADES/yash/topicModelDataset/Dataset_Corpus/lda_model_train_30.lda', mmap='r')
    ###########################################################################################
    ...
    for ind in data.keys():
        ...
        print "TOTAL = 20K something :  " + str(counter)
    #with open('/media/DADES/yash/newInceptionLabels/Dataset_dict/validation_label.json','w') as fp:
